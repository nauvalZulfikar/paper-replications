...
<style>
  ...
  *{{box-sizing:border-box}} html,body{{margin:0;padding:0}}
  ...
  .rlink{{color:var(--acc);text-decoration:none;font-weight:700}}
  ...
  .roadmap[open] summary::before{{content:"▾ "}}
  .rmlist{{margin:2px 0 8px;padding:0 14px 0 42px;display:flex;flex-direction:column;gap:9px;counter-reset:rm}}
  .rmlist li{{font-size:13.5px;line-height:1.5;position:relative}}
  .rmlist li::marker{{color:var(--mut);font-weight:800}}
  .rmtag{{font-size:10px;font-weight:800;color:#0b0e14;padding:1px 6px;border-radius:5px;margin-right:7px}}
  .rmlist .badge{{margin:0 4px}}
  .rmlist .read{{margin-left:6px}}
  .more{{margin-top:1px}}
...
<header>
  <div class="wrap">
    ...
    <a class="repobtn" href="https://github.com/nauvalZulfikar/paper-replications" target="_blank" rel="noopener">🧑‍💻 Repo replikasi (portfolio) → github.com/nauvalZulfikar/paper-replications</a>
    <div class="meta">
...
<div class="wrap">{ROADMAP_HTML}</div>
...
<footer class="wrap">
  ...
  <p>Kerjaan replikasi (portfolio): <a class="rlink" href="https://github.com/nauvalZulfikar/paper-replications" target="_blank" rel="noopener">github.com/nauvalZulfikar/paper-replications</a> — progres nyusul di badge status tiap card (⬜→🟡→✅).</p>
  <p>Repo situs: <code>~/coding-projects/ai-ladder-lab</code> · regen: <code>python3 build.py</code> · gabungan quant-ladder + ai-ladder.</p>
</footer>
